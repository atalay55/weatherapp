...
class Data{
  ...
  Data({required this.coord,required this.weather,required this.base,required this.datamain,required this.visibility,required this.clouds,required this.dt,required this.sys,required this.timeZone,required this.id,
